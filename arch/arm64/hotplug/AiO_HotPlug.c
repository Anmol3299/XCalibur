 ...
 * Hexa-Core and Octa-Core big.LITTLE SoCs.
 *
...
#ifdef CONFIG_CORE_CONTROL_v2
// Variable required to know the status of Core Control v2.0.
			     ...
			     const char *buf, size_t count)
{
	...
	#ifdef CONFIG_CORE_CONTROL_v2
	// Allow AiO HotPlug to be Enabled only when Core Control v2.0 is Disabled.
	if (core_control)
	   return -EINVAL;
	#endif
